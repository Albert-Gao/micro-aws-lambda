...
export const getMockEvent = (): APIGatewayEvent => {
  const event: APIGatewayEvent & { version: string } = {
    version: '1.0',
    resource: '/company',
    path: '/company',
    httpMethod: 'POST',
    ...
    multiValueHeaders: {
      ...
      Via: ['1.1 3fb80f1162ff0374e396394904e92ee5.cloudfront.net (CloudFront)'],
      'X-Amz-Cf-Id': [
        'h-M345yF6GFaRP92GUDDhyOfBWHvXpGzagkYfpUR3InjbH31mLflmQ==',
      ],
      'X-Amzn-Trace-Id': ['Root=1-5d21a645-0f40601bd42aedf5575b0ddc'],
      'X-Forwarded-For': ['115.188.84.216, 70.132.29.114'],
      'X-Forwarded-Port': ['443'],
...
export const getMockContext = (
  ...
  const context: Context & { invokeid: string } = {
    ...
    ...(params.hasFuncs ? contextFuncs : noopContextFuncs),
  };
